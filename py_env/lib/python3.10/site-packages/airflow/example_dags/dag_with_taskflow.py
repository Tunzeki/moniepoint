...
@dag(
        dag_id="dag_with_sqlite_operator_v21",
...
def tripdata_etl():
    ...
    @task()
    def extract():
        with open('/home/tunzeki/airflow_ex/pyt_env/lib/python3.10/site-packages/airflow/example_dags/result.csv','r') as fetched_metrics:
    ...
    @task()
    def load(to_db):
        con = sqlite3.connect("/home/tunzeki/airflow_ex/tripdata.db")
        cur = con.cursor()
        cur.execute("""
